    ...
    public void onBindViewHolder(@NonNull NewsViewHolder holder, int position) {
        ...
        if (imageUrl != null && !imageUrl.isEmpty()) {
            Picasso.get().load(imageUrl)
                    .error(R.drawable.new_loading)
                    .placeholder(R.drawable.new_loading)
            ...
            // If the URL is null or empty, you might want to handle this case.
            // For now, we're using a placeholder image.
            holder.imageView.setImageResource(R.drawable.ni_image_icon);
        }
    }
